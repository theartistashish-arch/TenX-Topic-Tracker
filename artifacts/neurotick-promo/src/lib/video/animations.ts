...
// Transitions are intentionally kept separate (passed via component `transition` prop)
// because framer-motion v12 Variants type doesn't allow `transition` inside variant values.
...
export const charContainerTransition = {
...
// Common variants.
// Transitions are kept separate (passed via component `transition` prop)
// because framer-motion v12 Variants type doesn't allow `transition` inside variant values.
...
export const containerTransition = staggerConfigs.medium;
...
export const itemTransition = { duration: 0.5, ease: 'circOut' as const };
